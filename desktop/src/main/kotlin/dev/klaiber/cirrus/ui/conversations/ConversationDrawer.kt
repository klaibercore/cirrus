...
fun ConversationDrawer(
    ...
    ModalDrawerSheet(
        ...
        Column(Modifier.fillMaxSize()) {
            Row(
                ...
                IconButton(onClick = model::toggleArchivedView) {
                    Icon(
            ...
            if (state.conversations.isEmpty()) {
                ...
                ConversationList(
                    ...
                    onTogglePin = { model.setPinned(it.conversation.id, !it.conversation.pinned) },
                    onToggleArchive = {
                        model.setArchived(it.conversation.id, !it.conversation.archived)
                    },
    ...
    renameTarget?.let { target ->
        RenameDialog(
            ...
            onConfirm = { title ->
                model.rename(target.conversation.id, title)
                renameTarget = null
            },
    ...
    deleteTarget?.let { target ->
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        model.delete(target.conversation.id)
                        deleteTarget = null
                    },
                ) {
